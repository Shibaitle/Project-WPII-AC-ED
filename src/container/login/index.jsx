                ...
                <div className="bg-slate-200 border border-slate-400 rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-sm bg-opacity-30 relative">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <Link to="" className="text-amber-400">Forgot Password</Link>
                        </div>
                        <button
                          type="submit"
                          className="w-full mb-4 text-[18px] mt-6 rounded-full bg-white text-amber-600 hover:bg-amber-600 hover:text-white py-2 transition-colors duration-300">Login</button>
                        <div>
                            <span className="m-4">
                                New Here? <Link className="text-amber-400" to="/register">Register Now!!</Link>
                            </span>
                        </div>
                    </form>
                </div>
